				...
				>
					...
					<TabTrigger name="index" href="/" asChild>
						<TabButton
							...
							icon={({ color, strokeWidth }) => (
								<IconMeteor size={28} color={color} strokeWidth={strokeWidth} />
							)}
						/>
					</TabTrigger>
					...
					<TabTrigger name="world" href="/world" asChild>
						<TabButton
							...
							href="/world"
							icon={({ color, strokeWidth }) => (
								<IconGlobe size={28} color={color} strokeWidth={strokeWidth} />
							)}
						/>
					</TabTrigger>
					<TabTrigger name="profile" href="/profile" asChild>
						<TabButton
							...
							href="/profile"
							icon={({ color, strokeWidth }) => (
								<IconUser size={28} color={color} strokeWidth={strokeWidth} />
							)}
						/>
					</TabTrigger>
				</TabList>
